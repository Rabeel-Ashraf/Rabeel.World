            ...
            >
              {expertise.map((skill, index) => (
                <motion.span
                  ...
                  className="px-4 py-2 text-sm border border-border rounded-full hover:border-foreground/30 hover:text-foreground transition-colors duration-300 magnetic lowercase"
                >
                  {skill}
                </motion.span>
              ))}
              ...
              {timeline.map((item, index) => (
                ...
                >
                  ...
                  <div className="absolute -left-8 top-0 w-px h-full">
                    <div className="absolute -left-[3px] top-2 w-2 h-2 rounded-full bg-border group-hover:bg-foreground transition-colors duration-300" />
                  </div>
                  ...
                  <div className="luxury-card p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-foreground mb-1 lowercase">
                          {item.title}
                        </h4>
                        <p className="text-sm text-muted-foreground mb-2 lowercase">{item.company}</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <div className="text-sm text-muted-foreground tracking-wide lowercase">
                  {stat.label}
                </div>
              </motion.div>
            ))}
